...
export type ChangesTrackingWhereInput = {
  ...
  authorId?: Prisma.StringFilter<"ChangesTracking"> | string
...
export type ChangesTrackingScalarWhereWithAggregatesInput = {
  ...
  authorId?: Prisma.StringWithAggregatesFilter<"ChangesTracking"> | string
...
export type ChangesTrackingCreateInput = {
  ...
  modifiedBy: Prisma.UserCreateNestedOneWithoutChangesLogInput
}
...
export type ChangesTrackingUpdateInput = {
  ...
  newData?: Prisma.JsonNullValueInput | runtime.InputJsonValue
  oldData?: Prisma.JsonNullValueInput | runtime.InputJsonValue
  modifiedBy?: Prisma.UserUpdateOneRequiredWithoutChangesLogNestedInput
}
...
export type ChangesTrackingOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "doneAt" | "authorId" | "modelName" | "recordId" | "operation" | "newData" | "oldData", ExtArgs["result"]["changesTracking"]>
...
export interface ChangesTrackingFieldRefs {
  ...
  readonly authorId: Prisma.FieldRef<"ChangesTracking", 'String'>
